...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="AcasaONG.css">
            ...
            <div class="about">
                <div class="row1">
                    ...
                    <h1><center><?php 
                        ...
                        $selectquery="SELECT ID FROM `conturi asociatii` ORDER BY ID DESC LIMIT 1";
                    ...
                    <ol class="lista">
                        ...
                        ?>
                        <li>
                            <form action="http://localhost/Biblioteca%20Voluntarului/Profil%20ONG%20ONGuri/ProfilONGONGuri.php" method="post" target="_blank">
