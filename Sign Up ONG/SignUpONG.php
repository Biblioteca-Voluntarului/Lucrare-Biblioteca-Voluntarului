...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="stylesheet" href="SignUpONG.css">
    ...
    <body>
        <center>
            ...
            {
                $denumire_asociatie = $_POST['denumire_asociatie'];
                $CIF_CUI = $_POST['CIF_CUI'];
                ...
                $identical_email = "SELECT * FROM `conturi asociatii` WHERE `adresa_email` = '$adresa_email'";
                $verif_email = mysqli_query($conn, $identical_email);
                $identical_username = "SELECT * FROM `conturi asociatii` WHERE `CIF_CUI` = '$CIF_CUI'";
                ...
                {
                    echo '<script> alert("ONG deja înscris în baza de date!"); javascript:history.back();</script>';
                }
                ...
                elseif($parola == $cparola)
                {
                    ...
                    $sql = "INSERT INTO `conturi asociatii` (denumire_asociatie, CIF_CUI, adresa_email, numar_telefon, parola) VALUES ('$denumire_asociatie','$CIF_CUI','$adresa_email','$numar_telefon','$parola')";
                    if(mysqli_query($conn, $sql))
                    {
                        echo '<script> alert("Datele au fost salvate cu succes!"); </script>';
                        echo "<br><br><br><br><br><br><br><br><h1>Bun venit în comunitatea Biblioteca Voluntarului,</h1>";
                        echo "<h1>$denumire_asociatie!</h1>";
                        echo "<h2>Datele dumneavoastră sunt:</h2>";
                        echo "<b>Denumire asociație: </b>".$denumire_asociatie;
                        echo "<br><b>Username: </b>".$CIF_CUI;
                        ...
                        echo "<br><br><h2><a href='http://localhost/Biblioteca%20Voluntarului/Sign%20In%20ONG/SignInONG.html'>CONTUL MEU</a></h2>";                
                    }
                }
                else
                {
